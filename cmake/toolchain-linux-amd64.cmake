# Linux/amd64 cross-compilation toolchain for bridgesessions.
#
# Override the sysroot when configuring if your target packages live outside the
# compiler's default search paths:
#   cmake -DBRIDGESESSIONS_SYSROOT=/path/to/x86_64-linux-gnu-sysroot ...

set(CMAKE_SYSTEM_NAME Linux)
set(CMAKE_SYSTEM_PROCESSOR x86_64)
set(CMAKE_LIBRARY_ARCHITECTURE x86_64-linux-gnu)

set(CMAKE_C_COMPILER x86_64-linux-gnu-gcc CACHE FILEPATH "Cross C compiler" FORCE)
set(CMAKE_CXX_COMPILER x86_64-linux-gnu-g++ CACHE FILEPATH "Cross C++ compiler" FORCE)
set(CMAKE_AR x86_64-linux-gnu-ar CACHE FILEPATH "Cross archiver" FORCE)
set(CMAKE_RANLIB x86_64-linux-gnu-ranlib CACHE FILEPATH "Cross ranlib" FORCE)
set(CMAKE_STRIP x86_64-linux-gnu-strip CACHE FILEPATH "Cross strip" FORCE)
