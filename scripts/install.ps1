...
#
#   irm https://raw.githubusercontent.com/MindDragonLabs/BridgeSessions/v/26.08.12-beta3/scripts/install.ps1 | iex
#

$ErrorActionPreference = "Stop"
$TAG = if ($env:BRIDGESESSIONS_TAG) { $env:BRIDGESESSIONS_TAG } else { "26.08.12-beta3" }
