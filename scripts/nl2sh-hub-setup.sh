#!/usr/bin/env bash
# Install whatisit-nl2sh + Q4_K_M weights on a fleet hub (peer-linux-a / peer-linux-b).
...
echo "  bs shell peer-linux-a --cmd 'curl -sS 127.0.0.1:$PORT/v1/nl2sh -H Content-Type:application/json -d \"{\\\"q\\\":\\\"disk free\\\",\\\"os\\\":\\\"linux\\\"}\"'"
