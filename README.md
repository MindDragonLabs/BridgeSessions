...
Current release tag: **`26.09.03-release`**.
...
The version string must contain `26.09.03-release`.
...
2. Confirm `bs --version` prints `26.09.03-release`.
