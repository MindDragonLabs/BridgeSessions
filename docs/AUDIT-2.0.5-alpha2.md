...
| P1 | Release artifacts were mislabeled/stale | macOS/Windows binaries were older builds, Linux metadata reported 2.0.6-alpha2, Hello advertised 1.0.0, and BridgePanel reported 2.0.0. A canonical `VERSION` file now drives CMake, CLI, Hello, BridgePanel, scripts, and artifact gates. |
