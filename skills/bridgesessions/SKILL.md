...
- **Current version: `26.08.10-beta2`** (main branch on Codeberg).
...
## Public release (`v26.08.10-beta2`)
...
bs --version                          # expect 26.08.10-beta2
...
## Security posture (v26.08.10-beta2)
...
- Release notes: `docs/RELEASE-NOTES-26.08.10-beta2.md`
