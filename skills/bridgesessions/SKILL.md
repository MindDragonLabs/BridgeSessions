...
- **Current public release: `v2.0.5-alpha2`** (multi-platform alpha on Codeberg).
...
## Public release (`v2.0.5-alpha2`)

| Fact | Value |
|------|--------|
| Tag | `v2.0.5-alpha2` (annotated name on one commit — the version stamp) |
| Branch | `main` |
...
| Notes | `docs/RELEASE-NOTES-2.0.5-alpha2.md` · provenance `docs/RELEASE-PROVENANCE.md` |

### Download (raw from tag — preferred)

```text
https://codeberg.org/Mind-Dragon/BridgeSessions/raw/tag/v2.0.5-alpha2/dist/bridgesessions-linux-x86_64
https://codeberg.org/Mind-Dragon/BridgeSessions/raw/tag/v2.0.5-alpha2/dist/bridgesessions-windows-x86_64.exe
https://codeberg.org/Mind-Dragon/BridgeSessions/raw/tag/v2.0.5-alpha2/dist/bridgesessions-macos-arm64
https://codeberg.org/Mind-Dragon/BridgeSessions/raw/tag/v2.0.5-alpha2/dist/bridgesessions-2.0.5-alpha2-source.tar.gz
https://codeberg.org/Mind-Dragon/BridgeSessions/raw/tag/v2.0.5-alpha2/dist/SHA256SUMS
```

Tree: https://codeberg.org/Mind-Dragon/BridgeSessions/src/tag/v2.0.5-alpha2/dist
...
## Security posture (v2.0.5-alpha2)
...
- Release notes: `docs/RELEASE-NOTES-2.0.5-alpha2.md`
...
curl -fsI https://codeberg.org/Mind-Dragon/BridgeSessions/raw/tag/v2.0.5-alpha2/dist/SHA256SUMS
```
